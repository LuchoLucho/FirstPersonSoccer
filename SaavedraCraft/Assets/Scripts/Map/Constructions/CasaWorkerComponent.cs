...
{
    public class CasaWorkerComponent : CasaWorkerModel<Component>
    {
        public CasaWorkerComponent(string aName, Component aComponent, int newI, int newj, ICentralMarket<Component> newCentralMarket) : base(aName, aComponent, newI, newj, newCentralMarket)
        {
        }
        ...
        {
            return new CasaWorkerComponent(this.GetName(), this.GetComponentMolde(), this.GetCoordI(), this.GetCoordJ(), centralMarket);
        }
    }
}
